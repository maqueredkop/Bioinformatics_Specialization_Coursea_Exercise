...
#peptide = 'C9\x87h\x88:'
#peptide = 'a\x97J\x97PBWL\x87CYHf\x87cIa\x97aa\x97JPB'
...
#highest_score = linear_scoring(peptide, spectrum)
print(highest_score)


for i in leader_peptide_list:
    if cyclopeptide_scoring(i, spectrum) == highest_score:
    #if linear_scoring(i, spectrum) == highest_score:
